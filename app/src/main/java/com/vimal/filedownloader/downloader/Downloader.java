...
import com.vimal.filedownloader.downloader.utils.Constants;
import com.vimal.filedownloader.downloader.utils.Strings;
...
import static com.vimal.filedownloader.downloader.utils.Strings.DOWNLOAD_DEFAULT_DIRECTORY;
import static com.vimal.filedownloader.downloader.utils.Utils.createDirectory;
import static com.vimal.filedownloader.downloader.utils.Utils.getAppTargetSdkVersion;
import static com.vimal.filedownloader.downloader.utils.Utils.isIdEmpty;
import static com.vimal.filedownloader.downloader.utils.Utils.isValidDefaultDirectory;
import static com.vimal.filedownloader.downloader.utils.Utils.isValidDirectory;
...
public class Downloader {
    ...
    private com.vimal.filedownloader.downloader.interfaces.DownloadListener mListener;
    ...
    private static int resumeDownload(Context context, long downloadId) {
        if (downloadId >= 0) {
            try {
                ...
                System.out.println("DOWNLOADED  : resume : value "+downloadId);
                System.out.println("DOWNLOADED  : resume : value "+values);
                return mResolver.update(ContentUris.withAppendedId(mBaseUri, downloadId), values,
                        null, null);
            } catch (Exception e) {
//                Log.print("Resuming encountered an error");
                System.out.println("DOWNLOADED  : resume : "+e.getMessage());
            }
        } else {
//            Log.print("Download id not found");
            System.out.println("DOWNLOADED  : resume : dd "+downloadId);
        }
        return -1;
    }
...
//                Log.printItems(downloadItem);
    ...
    public static DownloadItem getDownloadItem(Context context, String token) {
        if (context == null || isIdEmpty(token)) {
            return null;
        }
